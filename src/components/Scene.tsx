...
import goku from '../../assets/images/Pixel Art (Goku) 1.png'
...
export function Scene({ activeIndex, onNext, onPrevious, onSelect, sections }: SceneProps) {
  return (
    <div className="scene" role="presentation">
      ...
      <Orbit activeIndex={activeIndex} onSelect={onSelect} sections={sections} />
