...
const Hero = () => {
  return (
    <div className="relative flex flex-col items-center justify-center h-screen bg-darkBlue text-white">
      ...
      <Spotlight className="-top-40 -right-10 md:-left-32 md:-top-20 h-screen" fill="red" />
      ...
      <div className="absolute top-8 w-full flex justify-between items-center px-12">
        <h1 className="text-lg font-bold">WAJEEH ALAM</h1>
      </div>

      {/* Main Heading */}
      <div className="text-center">
        <h1 className="text-4xl sm:text-5xl font-extrabold">
          Hey, I'm <span className="text-purple-500">Wajeeh</span>! 👋
        </h1>
        <TextGenerateEffect
